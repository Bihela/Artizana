// tests/integration/ngoApplication.integration.test.js
const request = require('supertest');
const express = require('express');
const router = require('../../src/routes/ngoApplication');
...
uploadFileToFirebase.mockResolvedValue('https://mock.firebase/url.pdf');
